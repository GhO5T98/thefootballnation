...
const Transfers = () => {
  ...
  const transferNews = allNews.filter(
    (obj) => obj.hashtags && obj.hashtags.includes("Transfers")
  );
  ...
  const lastPage = Math.ceil(transferNews.length / objectsPerPage);
  const currentObjects = transferNews.slice(
    indexOfFirstObject,
    indexOfLastObject
  );
  ...
  return (
    <section className="transfers__section">
      <div className="transfers__hero">
        ...
        <h1 className="transfers__hero-txt">Transfers</h1>
