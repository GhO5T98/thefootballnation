...
const Ligue1 = () => {
  ...
  const ligueNews = allNews.filter((obj) => obj.compTag === "Ligue 1");
  ...
  const lastPage = Math.ceil(ligueNews.length / objectsPerPage);
  const currentObjects = ligueNews.slice(indexOfFirstObject, indexOfLastObject);
  ...
  return (
    <section className="transfers__section">
      <div className="transfers__hero">
        ...
        <h1 className="transfers__hero-txt">Ligue 1</h1>
        <Breadcrumb>
          <Breadcrumb.Item href="/">Home</Breadcrumb.Item>
          <Breadcrumb.Item active>Ligue 1</Breadcrumb.Item>
        </Breadcrumb>
