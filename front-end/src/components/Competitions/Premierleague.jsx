...
const Premierleague = () => {
  ...
  const plNews = allNews.filter((obj) => obj.compTag === "Premier League");
  ...
  const lastPage = Math.ceil(plNews.length / objectsPerPage);
  const currentObjects = plNews.slice(
    indexOfFirstObject,
    indexOfLastObject
  );
  ...
  return (
    <section className="transfers__section">
      <div className="transfers__hero">
        ...
        <h1 className="transfers__hero-txt">Premier League</h1>
        <Breadcrumb>
          <Breadcrumb.Item href="/">Home</Breadcrumb.Item>
          <Breadcrumb.Item active>Premier League</Breadcrumb.Item>
        </Breadcrumb>
