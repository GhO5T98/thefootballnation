...
const Seria = () => {
  ...
  const seriaNews = allNews.filter((obj) => obj.compTag === "Seria A");
  ...
  const lastPage = Math.ceil(seriaNews.length / objectsPerPage);
  const currentObjects = seriaNews.slice(indexOfFirstObject, indexOfLastObject);
  ...
  return (
    <section className="transfers__section">
      <div className="transfers__hero">
        ...
        <h1 className="transfers__hero-txt">Seria A</h1>
        <Breadcrumb>
          <Breadcrumb.Item href="/">Home</Breadcrumb.Item>
          <Breadcrumb.Item active>Seria A</Breadcrumb.Item>
        </Breadcrumb>
