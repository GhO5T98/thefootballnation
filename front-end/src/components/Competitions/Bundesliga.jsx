...
const Bundesliga = () => {
  ...
  const bundesligaNews = allNews.filter((obj) => obj.compTag === "Bundesliga");
  ...
  const lastPage = Math.ceil(bundesligaNews.length / objectsPerPage);
  const currentObjects = bundesligaNews.slice(
    indexOfFirstObject,
    indexOfLastObject
  );
  ...
  return (
    <section className="transfers__section">
      <div className="transfers__hero">
        ...
        <h1 className="transfers__hero-txt">Bundesliga</h1>
        <Breadcrumb>
          <Breadcrumb.Item href="/">Home</Breadcrumb.Item>
          <Breadcrumb.Item active>Bundesliga</Breadcrumb.Item>
        </Breadcrumb>
